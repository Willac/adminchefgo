    ...
    <div class="row tile_count">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 tile_stats_count">
            <a href="{{ route('admin.emoneys') }}">
                ...
                <div class="count red">{{ $emoneys }}</div>
            </a>
        </div>
        ...
        function initMap() {
            ...
            marker.addListener('click', function () {
                new google.maps.InfoWindow({
                    ...
                    '<div class="row form-group"><div class="col-xs-1 pull-left"><i class="fa fa-user-o"></i></div><div class="col-xs-9 pull-left"><a href="{{ route('admin.users.show', ['id' => $order->user->id]) }}">{{ $order->user->fullname() }}</a></div></div>' +
