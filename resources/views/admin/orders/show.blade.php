    ...
    <div class="row">
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th>User</th>
                <td><a target="_blank"
                       href="{{ route('admin.users.show', [$order->owner_id]) }}">{{ $order->user->fullname()  }}</a></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    @if($order->delivery_profile_id)
                        <a target="_blank"
                           href="{{ route('admin.delivery_profiles.show', [$order->delivery_profile_id]) }}">{{ $order->deliveryProfile->user->fullname()  }}</a>
                    @else
                        Not Assigned
                    @endif
...
@section('scripts')
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDsMDYrn-u3GZloJrEukRPvJqU9YBVIN2M&callback=initMap"
