...
@section('title',__('views.admin.users.edit.title', ['name' => $user->fullname()]) )
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last_name">
                    {{ __('views.admin.users.edit.last_name') }}
                    <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="last_name" type="text"
                           class="form-control col-md-7 col-xs-12 @if($errors->has('last_name')) parsley-error @endif"
                    ...
                    <div class="checkbox">
                        <label>
                            <input id="mobile_verified" type="checkbox" class="@if($errors->has('mobile_verified')) parsley-error @endif"
                                   name="mobile_verified" @if($user->mobile_verified) checked="checked" @endif value="1">
