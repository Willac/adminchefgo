...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::get('emoneys/{emoney}', 'EMoneyController@show')->name('emoneys.show');
        ...
        //Conekta
        Route::get('conekta/add/{id}', 'ConektaController@createClient')->name('conekta');
        Route::get('conekta/all', 'ConektaController@registerAll')->name('conekta');
        Route::get('conekta/delete', 'ConektaController@deleteAll');
        Route::get('conekta/find/{id}', 'ConektaController@showClient');
        Route::get('conekta/cards/{id}', 'ConektaController@cards');
        Route::get('conekta/addCard', 'ConektaController@addCard');
        Route::get('conekta/subscribe/{id}', 'ConektaController@subscribe');
        Route::get('conekta/deleteCard', 'ConektaController@deleteCard');
        Route::get('conekta/generatePay', 'ConektaController@generatePay');
        Route::get('conekta/generateReference', 'ConektaController@generateReference');
        
        Route::get('conekta/deleteAll', 'ConektaController@del');
...
Route::post('conekta/getPaymentWebHook', 'WebHookController@getPaymentWebHook');